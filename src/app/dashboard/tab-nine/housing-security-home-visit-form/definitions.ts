...
export const WellChildVisitsEnum = z.enum(['Newborn', '3-7 days old', '2-4 weeks old', '2-3 months old', '4-5 months old', '6-7 months old', '9-10 months old', '12-13 months old', '15-16 months old', '18-19 months old', '2-2.5 years old', '3-3.5 years old', '4-4.5 years old'])
...
export const HousingSecurityHomeVisitInputsSchema = z.object({
    ...
    erVisitSpecific: z.array(z.object({
        visitDate: z.union([z.date(), z.string().min(1, "Date of Visit is required")]).nullish().refine(val => val, { message: "Required" }),
        visitReason: VisitReasonEnum.nullish().refine(val => val, { message: "Required" })
    })).nullish(),
    ...
    wellChildVisitsSpecific: z.array(z.object({
        ...
        wellChildVisitsCompleted: z.array(WellChildVisitsEnum).nullish()
    })).nullish()
});
