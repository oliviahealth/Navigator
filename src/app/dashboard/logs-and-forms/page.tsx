    ...
    <div className="flex flex-col">
      <Accordion title="Appointment Log">
        {selectedAppointmentLogSubmission && (
          <div>
            {Array.isArray(
              selectedAppointmentLogSubmission.appointmentEntries
            ) &&
            selectedAppointmentLogSubmission.appointmentEntries.length > 0 ? (
              <div className="flex flex-wrap gap-4 mt-2">
                {selectedAppointmentLogSubmission.appointmentEntries.map(
      ...
      <Accordion title="Communication Log">
        {selectedCommunicationLogSubmission && (
          <div>
            {Array.isArray(
              selectedCommunicationLogSubmission.communicationEntries
            ) &&
            selectedCommunicationLogSubmission.communicationEntries.length >
              0 ? (
              <div className="flex flex-wrap gap-4 mt-2">
                {selectedCommunicationLogSubmission.communicationEntries.map(
                  (entry: any, index: number) => (
                    <div
                      key={index}
                      className="border p-2 rounded-md flex-1 min-w-[200px]"
                    >
                      ...
                      <p>
                        ...
                        {communicationLoglabelMapping[entry.method]}
                      </p>
                      <p>
                        <strong>Organization/Person:</strong>{" "}
                        {entry.organizationPerson}
                      </p>
                      <p>
                        <strong>Purpose:</strong> {entry.purpose || "N/A"}
                      </p>
                      <p>
                        <strong>Notes:</strong> {entry.notes || "N/A"}
                      </p>
          ...
          <div className="grid grid-cols-2 gap-4">
            <div className="border p-4 rounded-md">
              ...
              <p>
                ...
                {selectedEnrollmentFormSubmission.firstName}
              </p>
              <p>
                <strong>Last Name:</strong>{" "}
                {selectedEnrollmentFormSubmission.lastName}
              </p>
              <p>
                <strong>Date of Birth:</strong>{" "}
                {new Date(
                  selectedEnrollmentFormSubmission.dateOfBirth
                ).toLocaleString()}
              </p>
              <p>
                <strong>Address:</strong>{" "}
                {selectedEnrollmentFormSubmission.address}
              </p>
              <p>
                <strong>City:</strong> {selectedEnrollmentFormSubmission.city}
              </p>
              <p>
                <strong>State:</strong> {selectedEnrollmentFormSubmission.state}
              </p>
              <p>
                <strong>Zip:</strong> {selectedEnrollmentFormSubmission.zip}
              </p>
              <p>
                <strong>Home Phone:</strong>{" "}
                {selectedEnrollmentFormSubmission.homePhone}
              </p>
              <p>
                <strong>Cell Phone:</strong>{" "}
                {selectedEnrollmentFormSubmission.cellPhone}
              </p>
              <p>
                <strong>Email:</strong> {selectedEnrollmentFormSubmission.email}
              </p>
            </div>
            <div className="border p-4 rounded-md">
              ...
              <p>
                ...
                {selectedEnrollmentFormSubmission.clientName}
              </p>
              <p>
                <strong>Client Date:</strong>{" "}
                {new Date(
                  selectedEnrollmentFormSubmission.clientDate
                ).toLocaleString()}
              </p>
            </div>
            <div className="border p-4 rounded-md">
              ...
              <p>
                ...
                {selectedEnrollmentFormSubmission.guardianName
                  ? selectedEnrollmentFormSubmission.guardianName
                  : "N/A"}
              </p>
              <p>
                <strong>Guardian Date:</strong>{" "}
                {selectedEnrollmentFormSubmission.guardianName
                  ? new Date(
                      selectedEnrollmentFormSubmission.guardianDate
                    ).toLocaleString()
                  : "N/A"}
              </p>
            </div>
            <div className="border p-4 rounded-md">
              ...
              <p>
                <strong>GC-MOMS Name:</strong>{" "}
                {selectedEnrollmentFormSubmission.gcMomsName}
              </p>
              <p>
                <strong>GC-MOMS Date:</strong>{" "}
                {new Date(
                  selectedEnrollmentFormSubmission.gcMomsDate
                ).toLocaleString()}
              </p>
            </div>
            <div className="border p-4 rounded-md col-span-2">
              ...
              <div className="grid grid-cols-2 gap-4">
                {selectedEnrollmentFormSubmission.emergencyContacts.map(
          ...
          <div className="grid grid-cols-2 gap-4">
            <div className="border p-4 rounded-md">
              ...
              <p>
                ...
                {selectedMediaAppearanceReleaseSubmission.participantName}
              </p>
              <p>
                <strong>Address:</strong>{" "}
                {selectedMediaAppearanceReleaseSubmission.address}
              </p>
              <p>
                <strong>Participant Date:</strong>{" "}
                {new Date(
                  selectedMediaAppearanceReleaseSubmission.participantDate
                ).toLocaleString()}
              </p>
            </div>
