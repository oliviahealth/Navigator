...
export const labelMapping = {
    followUpAction: {
        Provide_support: "Provide developmental support activities -> Describe activities below (required)",
        Rescreen: "Rescreen at next interval (Record rescreen in OLIVIA-NAVIGATOR)",
        Refer_to_early_steps: "Refer to Early Steps or Child Find (Record in OLIVIA-NAVIGATOR Referral)",
        Refer_to_agency: "Refer to other community agency/provider (Record in OLIVIA-NAVIGATOR Referral)",
