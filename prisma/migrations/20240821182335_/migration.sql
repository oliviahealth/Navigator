/*
  ...
  - Added the required column `label` to the `IPVScreening` table without a default value. This is not possible if the table is not empty.
  - Added the required column `staffNotes` to the `IPVScreening` table without a default value. This is not possible if the table is not empty.
...
-- AlterTable
ALTER TABLE "IPVScreening" ADD COLUMN     "label" TEXT NOT NULL,
