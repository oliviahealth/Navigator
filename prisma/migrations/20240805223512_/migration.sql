/*
  ...
  - You are about to drop the column `siteID` on the `SocialSupportForm` table. All the data in the column will be lost.
...
-- AlterTable
ALTER TABLE "SocialSupportForm" DROP COLUMN "siteID",
