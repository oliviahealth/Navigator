/*
  ...
  - The values [phone,email,in_person,video_call,other] on the enum `CommunicationMethod` will be removed. If these variants are still used in the database, this will fail.

*/
-- AlterEnum
BEGIN;
CREATE TYPE "CommunicationMethod_new" AS ENUM ('Phone', 'Email', 'In_Person', 'Video_Call', 'Other');
