/*
  ...
  - The values [Email/Letter,In Person,Video Call] on the enum `CommunicationMethod` will be removed. If these variants are still used in the database, this will fail.

*/
-- AlterEnum
BEGIN;
CREATE TYPE "CommunicationMethod_new" AS ENUM ('Phone', 'Email_Letter', 'In_Person', 'Video_Call', 'Other');
